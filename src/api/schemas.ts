...
export const configUpdateSchema = z.object({
  ...
  levelUpChannelId: z.string().max(20).optional().nullable(),
  levelUpMessage: z.string().max(500).optional().nullable(),
  levelRoles: z.array(z.object({ level: z.number().int(), roleId: z.string() })).optional().nullable(),
  levelIgnoredChannels: z.array(z.string()).optional(),
  levelIgnoredRoles: z.array(z.string()).optional(),
